"""
Practicing automating different common mobile interactions in test app on iOS
"""
from page_objects.iOS.home_page import HomePage
from page_objects.iOS.picker_wheel_page import PickerWheelPage
from page_objects.iOS.steppers_page import SteppersPage


def test_send_keys(driver_ios_app):
    page = HomePage(driver_ios_app)
...
def test_scrolling(driver_ios_app):
    page = HomePage(driver_ios_app)
...
def test_increment(driver_ios_app):
    page = SteppersPage(driver_ios_app)
...
def test_find_element(driver_ios_app):
    page = SteppersPage(driver_ios_app)
    page.open_page("Steppers")
...
def test_picker_wheel(driver_ios_app):
    page = PickerWheelPage(driver_ios_app)
